...
class Product(models.Model):
    name = models.CharField(max_length=50, blank=False, default='Sin nombre')
    categoria = models.CharField(max_length=50, blank=False, default='Sin nombre')
    shortDescription = models.CharField(max_length=200, blank=False, default='Sin descripcion')
    description = models.TextField(max_length=1200, blank=False, default='Sin descripcion')
